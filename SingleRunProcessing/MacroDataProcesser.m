...
%% Input Conditions
    ...
    run = [5479];  %from uniqueruns, can be a vector if you want to process multiple runs in a row
    ...
    total_im_process = 200; %NaN if process all
    total_im_preprocess = 200; 
    lens_standoff_dist = 300; %mm
    fitting_limits =    [25,NaN,4.5,10,NaN,6;...
                        2000,NaN,4.5,1000,NaN,6;...
                        4096,NaN,4.5,4096,NaN,6]; %LB,x0,UB
    ...
    flare_constants = [ 1,0.25,2;...
                        ...
                        4,0.45,0;...
                        0,0.1,0;...
                        2,0.20,8];  %first column is moving down, second column is amplitude scale
    g1_scale_constants = [0.15,0.8;...
                        .1,0.6;...
                        0,.45;...
                        .15,.6;...
                        0.25,.5;... 
                        ...
                        0,.75;...   
                        0,.8;... 
                        0.05,.75]; %scales the amplitude of g1 near the wall. Pos for smaller G1, neg for bigger G1
