function [ideal_image_ROI,gate2_trimmed,gate2_image_ROI,...
...
Amp_g1_mod = smooth(Amp_g1,12,'lowess');
Amp_g2_mod = smooth(Amp_g2,8,'lowess');
mean_SNR = smooth(mean_SNR,8,'lowess');
Amp_gates = [Amp_g1,Amp_g2];
...
trimrows = count_rows;
rows_offset = ceil(emissionlocatingdata(2)-trimrows)+3;
