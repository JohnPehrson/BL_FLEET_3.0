function [velocity,random_velocity_error,systematic_velocity_error] = VelocityFinder(centroids,centroid_error,centroids_covar,resolution,gates,delays)
%This function finds the velocity of the flow based on the centroids.
        ...
        velocity = dx/dt;
        dx_pix_err = sqrt(centroid_error(1)^2+centroid_error(2)^2-2*centroids_covar);
